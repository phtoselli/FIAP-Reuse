...
import { UserModel, UserCreateModel, UserUpdateModel, UserResponseModel } from '@/types/user/UserModel';
...
export class UserService {
   ...
   */
  async updateUser(id: string, userData: UserUpdateModel): Promise<UserResponseModel> {
    try {
